...
class MyTestCase(unittest.TestCase):
    ...
    def test_exponential(self):
        ...
        variable = ExcelVariable(name='energy_intensity_network', excel_file_name='tests/data/test_data.xlsx', sheet_name='Sheet3', times=pd.date_range('2019-06-01', '2020-06-01', freq='MS'))
